...
# =============================================================================
#
# defaults/defaults_master.csv is the authority but is long-format and awkward
# to read. This renders it as defaults/DEFAULTS_MASTER.md: wide tables per
...
out <- c(
  "# Defaults master",
  "",
  sprintf("Generated %s from `defaults/defaults_master.csv` by `scripts/build_defaults_master_doc.R`. Do not edit this file; edit the CSV.",
          Sys.Date()),
  "",
...
out <- c(out, "",
  "The `DEVIATION_OPEN` rows are the ones that would move a reported number if resolved. They are listed in full at the end of this document and discussed in `defaults/provenance_register.md`.",
  "")
...
writeLines(out, "defaults/DEFAULTS_MASTER.md", useBytes = TRUE)
cat("wrote defaults/DEFAULTS_MASTER.md (", length(out), " lines)\n", sep = "")
