...
| `Bo` | advanced | coefficient | m3 CH₄/kg VS | 0.10 | 20% | pert | Table 10.16a | (none) | Maximum CH₄ producing capacity of manure (IPCC Vol.4 Ch.10 Table 10.16a, 2019R): **other cattle = 0.10**, **dairy cattle = 0.24**. Default below assumes other cattle (the more common case across mixed inventories); for dairy_cows override to 0.24. 2006 used a single 0.13 midpoint, which is why some older inventories report it. |
