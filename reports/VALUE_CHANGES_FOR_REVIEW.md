...
|---|---|---|
| `APPLIED` | 88 | Already changed. The IPCC basis was unambiguous and no review round had ruled on the value. Please endorse, or object. |
...
| MMS_DEFAULTS | anaerobic_digester | mcf_tropical_dry | 3.5 | 4.59 | manure CH4 | Mirrors mcf_tropical on every system, so it carries the same value read from 2006 V4 Ch10 Table 10.17, MCF by average annual temperature (or, for the two systems that table does not cover, their stated source). The 2019 Refinement splits ten climate zones including Tropical Dry, which the tool's four-band model does not resolve; the tropical value is used for both |
...
| MMS_DEFAULTS | deep_bedding | mcf_tropical_dry | 30 | 80 | manure CH4 | Mirrors mcf_tropical on every system, so it carries the same value read from 2006 V4 Ch10 Table 10.17, MCF by average annual temperature (or, for the two systems that table does not cover, their stated source). The 2019 Refinement splits ten climate zones including Tropical Dry, which the tool's four-band model does not resolve; the tropical value is used for both |
...
| MMS_DEFAULTS | dry_lot | mcf_tropical_dry | 5 | 2 | manure CH4 | Mirrors mcf_tropical on every system, so it carries the same value read from 2006 V4 Ch10 Table 10.17, MCF by average annual temperature (or, for the two systems that table does not cover, their stated source). The 2019 Refinement splits ten climate zones including Tropical Dry, which the tool's four-band model does not resolve; the tropical value is used for both |
...
| MMS_DEFAULTS | liquid_slurry | mcf_tropical_dry | 80 | 50 | manure CH4 | Mirrors mcf_tropical on every system, so it carries the same value read from 2006 V4 Ch10 Table 10.17, MCF by average annual temperature (or, for the two systems that table does not cover, their stated source). The 2019 Refinement splits ten climate zones including Tropical Dry, which the tool's four-band model does not resolve; the tropical value is used for both |
...
| MMS_DEFAULTS | pasture | mcf_tropical_dry | 1.5 | 2 | manure CH4 | Mirrors mcf_tropical on every system, so it carries the same value read from 2006 V4 Ch10 Table 10.17, MCF by average annual temperature (or, for the two systems that table does not cover, their stated source). The 2019 Refinement splits ten climate zones including Tropical Dry, which the tool's four-band model does not resolve; the tropical value is used for both |
...
| MMS_DEFAULTS | solid_storage_covered | mcf_tropical_dry | 4 | 5 | manure CH4 | Mirrors mcf_tropical on every system, so it carries the same value read from 2006 V4 Ch10 Table 10.17, MCF by average annual temperature (or, for the two systems that table does not cover, their stated source). The 2019 Refinement splits ten climate zones including Tropical Dry, which the tool's four-band model does not resolve; the tropical value is used for both |
...
| PARAM_CATALOGUE | ASH | ipcc_ref | Eq 10.24 | Eq 10.24 (note) | volatile solids, so manure CH4 | Citation change only, no value moved. |
...
| PARAM_CATALOGUE | BW | ipcc_ref | Table 10A.2 | Table 10A.1 | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
| PARAM_CATALOGUE | C | ipcc_ref | Eq 10.6 | Eq 10.6 (note) | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
...
| PARAM_CATALOGUE | CP | ipcc_ref | Eq 10.32 | Table 10A.1 | N excretion | Citation change only, no value moved. |
...
| PARAM_CATALOGUE | DE | ipcc_ref | Eq 10.14--16 | Table 10A.1 | gross energy | Citation change only, no value moved. |
| PARAM_CATALOGUE | Fat | ipcc_ref |  | Table 10A.1 | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
| PARAM_CATALOGUE | hours | ipcc_ref | Eq 10.11 | Table 10A.1 | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
| PARAM_CATALOGUE | Milk | ipcc_ref |  | Table 10A.1 | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
...
| PARAM_CATALOGUE | MilkPR | ipcc_ref | Eq 10.33 | Table 10A.1 | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
...
| PARAM_CATALOGUE | pct_pregnant | ipcc_ref |  | Table 10A.1 | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
| PARAM_CATALOGUE | Tw | ipcc_ref | Eq 10.2 |  | gross energy, so enteric CH4 + manure CH4 | Citation change only, no value moved. |
| PARAM_CATALOGUE | UE | ipcc_ref | Eq 10.24 | Eq 10.24 (note) | volatile solids, so manure CH4 | Citation change only, no value moved. |
